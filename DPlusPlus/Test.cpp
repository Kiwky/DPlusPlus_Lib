...
public:
	...
	void OnInviteCreate(const User &user, const std::string &guild_id, const std::string &channel_id, const std::string &code, int max_use, bool temporary) {
	...
	void OnInviteDelete(const std::string &guild_id, const std::string &channel_id, const std::string &code) {
		cout << "GID: " << guild_id << "\n";
		cout << "CID: " << channel_id << "\n";
		cout << "Code: " << code << "\n";
	}
